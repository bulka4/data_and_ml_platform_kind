...
which uses the iceberg_catalog catalog as the default one. If we try to use Spark with this config and the default schema doesn't exist, 
it will through an error that there is no 'default' schema.
